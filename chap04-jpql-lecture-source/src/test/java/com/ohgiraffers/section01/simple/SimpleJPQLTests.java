...
public class SimpleJPQLTests {
    ...
    /*
    * JPQL
    * 엔티티객체를 중심으로 개발할수있는 객체 지향 쿼리
    * SQL보다 간결하고, 특정 DBMS에 의존하지 않는다
    * 방언을 통해 해당 DBMS에 맞는 SQL을 실행하게된다
    * JPQL은 Find메서드를 통한 조회와 다르게 항상 데이터베이스에서 sql을 실행해서 결과를 조회
    * */
    ...
    * */
    ...
    @Test
    @DisplayName("typequery를 이용한 단일 메뉴 조회 테스트")
    public void test1(){
        //given
    ...
    @Test
    @DisplayName("Query를 이용한 단일 메뉴 조회테스트")
        void  test2(){
            //given
    ...
    @Test
    @DisplayName("typequery를 이용한 단일행 조회 테스트")
    public void test3() {
        //given
        ...
        TypedQuery<Menu> query
                = entityManager.createQuery(jpql, Menu.class); //반환타입을 매핑한 엔티티타입으로 설정
        Menu resultMenuName = query.getSingleResult(); //결과반환
    ...
    public void test5() {
        ...
        List<Object> menuList = query.getResultList(); //결과반환
