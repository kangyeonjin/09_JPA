...
@DisplayName("메뉴코드로 메뉴 조회테스트")
    @Test
    public void selectMenuByMenuCoderTest(){
...
@DisplayName("새로운 메뉴 추가테스트")
@Test
public void insertNewMenuTest(){
     //given
    Menu menu = new Menu();
    menu.setMenuName("JPA테스트용 신규 메뉴");
...
@DisplayName("메뉴 삭제하기 테스트")
    ...
    //then
    Menu remobvedMenu = entityManager.find(Menu.class, 23);
    Assertions.assertEquals(null, remobvedMenu);
}
