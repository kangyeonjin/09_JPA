...
public class A_EntityManagerLifeCycleTests {
    ...
    @BeforeAll //테스트 클래스 전체가 시작되기전 한번만 실행되는 메소드 정의
    ...
    @AfterAll //테스트 클래스 전체가 진행된후 한번만 실행되는 메소드 정의
    ...
    @DisplayName("엔티티매니져 팩토리와 엔티티매니져 생명주기확인1")
    @Test
    ...
    @DisplayName("엔티티매니져 팩토리와 엔티티매니져 생명주기확인2")
    @Test
